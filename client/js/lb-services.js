...
/**
 * @ngdoc object
 * @name lbServices.Veterinarian
 * @header lbServices.Veterinarian
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Veterinarian` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/veterinarians/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#create
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Veterinarian` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/veterinarians",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#upsert
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#exists
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/veterinarians/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#findById
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/veterinarians/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#find
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#findOne
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/veterinarians/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#updateAll
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/veterinarians/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#deleteById
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#count
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/veterinarians/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#prototype$updateAttributes
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#createChangeStream
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/veterinarians/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#toXML
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "toXML": {
          url: urlBase + "/veterinarians/petclinic/vets.xml",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#toAtom
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
         ...
         */
        "toAtom": {
          url: urlBase + "/veterinarians/petclinic/vets.atom",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#updateOrCreate
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#update
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#destroyById
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Veterinarian#removeById
         * @methodOf lbServices.Veterinarian
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Veterinarian#modelName
    * @propertyOf lbServices.Veterinarian
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Veterinarian`.
    */
    R.modelName = "Veterinarian";
